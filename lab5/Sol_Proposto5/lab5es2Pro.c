...
void child (int fd1[2],int fd2[2]) {
  ...
  //COSì NON OTTENGO DUE PIPE DI TROPPO? VISTO CHE DOPO IL FORK PADRE+FIGLIO EREDITA ANCHE LA STRUTTURA DEL PIPE MI BASTA FARNE UNA PRIMA DEL FORK E POI
  //TENERE QUELLO? (forse rivedi la parte di lezione del half-duplex?)
  while (1) {    
    read (fd1[0], tmp, N);
